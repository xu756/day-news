---
title: "OpenAI 宣布与战争部达成协议"
description: "OpenAI 公布了与战争部的合同细节，涵盖安全红线、法律保护及机密环境部署协议。"
pubDate: "2026-03-01"
category: "Policy & Defense"
why: "OpenAI released details of its contract with the Department of War, outlining safety red lines, legal protections, and deployment protocols for classified environments."
candidateCount: 125
sourceUrls:
...
candidateItems:
  ...
  - title: "The robots who predict the future"
    ...
    sourceType: "media"
    score: 30.57
heroImage: "https://techcrunch.com/wp-content/uploads/2026/02/GettyImages-2236544077.jpg?resize=1200,800"
---

OpenAI 首席执行官 Sam Altman 宣布，公司已与美国国防部（现称战争部）达成协议，允许其在机密网络中使用 OpenAI 的 AI 模型。

**协议核心内容**

*   **安全原则**：协议包含禁止大规模国内监控和人类对武力使用负责（包括自主武器系统）的条款。战争部同意这些原则并将其纳入法律和政策。
*   **技术保障**：OpenAI 将构建“安全堆栈”并派遣工程师协助五角大楼，以确保模型行为符合预期。
*   **拒绝机制**：如果模型拒绝执行某项任务，政府不会强迫 OpenAI 修改模型以执行该任务。

**背景与对比**

此协议是在 Anthropic 与五角大楼谈判破裂后达成的。此前，特朗普政府批评 Anthropic 并将其列为供应链风险。Altman 表示，OpenAI 的协议解决了 Anthropic 提出的关键问题，并呼吁战争部向所有 AI 公司提供相同的条款，以缓和法律和政府行动。
